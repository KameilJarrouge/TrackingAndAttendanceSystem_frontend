      ...
      <div className="w-full h-[88%] flex flex-col ">
        ...
        <table className="w-full table-fixed ">
          <thead className="w-full">
            <tr className="w-full">
              <THeader width="1/5">اسم الفصل</THeader>
              <THeader width="1/5"> العام الدراسي</THeader>
              <THeader width="1/5"> بداية الفصل</THeader>
              <THeader width="1/5"> عدد الأسابيع</THeader>
              <THeader width="1/5"> تحكم</THeader>
            </tr>
          </thead>
          <tbody>
