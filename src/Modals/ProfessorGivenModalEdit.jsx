...
function ProfessorGivenModalEdit({
  open,
  onClose,
  refresh,
  professorId,
        ...
        >
          <div className="w-11/12 my-4 ">
            <AppForm
              ...
              initialValues={{
                is_theory: selectedProfessor?.is_theory,
                time: new Date(
                  moment(
                    "2000-01-01 " + selectedProfessor?.time,
                    "yyyy-MM-DD HH:mm:ss"
                  ).toDate()
                ),
                day: selectedProfessor?.day,
                group: selectedProfessor?.group,
                attendance_pre: selectedProfessor?.attendance_pre || null,
                attendance_post: selectedProfessor?.attendance_post || null,
                attendance_present:
                  selectedProfessor?.attendance_present || null,
              }}
            ...
            >
              ...
              <div className="w-full flex flex-row-reverse">
                <Autocomplete
                  ...
                  getOptionLabel={(option) => `${option?.professor.name}`}
...
export default ProfessorGivenModalEdit;
