...
function SubjectGivenModalAdd({ open, onClose, refresh, professorId }) {
  ...
  const getSubjectOptions = async () => {
    let res = await api.get(`/api/subjects/professors/options`);
  ...
  const handlesubmit = async (values) => {
    ...
    const res = await api.post(`/api/professors/${professorId}/add-subject`, {
...
export default SubjectGivenModalAdd;
