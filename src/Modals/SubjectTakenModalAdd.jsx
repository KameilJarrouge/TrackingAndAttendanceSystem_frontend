...
function SubjectTakenModalAdd({ open, onClose, refresh, studentId }) {
  ...
  const getGivenSubjectsOptions = async () => {
    let res = await api.get(`/api/given-subjects/${selectedSubject.id}/theory`);
    console.log("====================================");
  ...
  const getSubjectOptions = async () => {
    ...
    let res = await api.get(`/api/subjects/students/${studentId}/options`);
  ...
  const handlesubmit = async () => {
    ...
    const res = await api.post(`/api/students/${studentId}/add-subject`, {
...
export default SubjectTakenModalAdd;
